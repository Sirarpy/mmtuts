...
<!--            <div class="align-center">-->
                <div class=" bd-highlight" style="background-color: #b6baf2; max-width: 30%; margin:5px">
                    <div class="media position-relative">
                        <img src="../images/<?= $matche['picture']; ?>" class="mr-3" alt="img" style="max-width: 20%">
                        <div class="media-body">
                            <h5 class="mt-0"><?= $matche['title']; ?></h5>
                            <p><?= $matche['article']; ?></p>
                            <h6>Author <a href="visit.php?user=<?= $matche['id'] ?>"
                                          class="link"><?= $matche['f_name']; ?></a></h6>
                        </div>
                    </div>
                </div>
<!--            </div>-->
